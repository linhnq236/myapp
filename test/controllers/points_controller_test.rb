...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { course_id: @point.course_id, date: @point.date, people_id: @point.people_id, point: @point.point } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { course_id: @point.course_id, date: @point.date, people_id: @point.people_id, point: @point.point } }
